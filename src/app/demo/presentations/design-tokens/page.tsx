      ...
      content: (
        <div className='space-y-8'>
          <blockquote className='text-2xl font-light italic border-l-4 border-yellow-300 pl-6 text-gray-200 bg-gray-800/50 p-6 rounded-r-lg'>
            Design tokens are{' '}
            <strong className='text-yellow-300'>named entities</strong> that
            store visual design attributes. They are the{' '}
            <strong className='text-yellow-300'>smallest atoms</strong> of a
            design system.
          </blockquote>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            <div>
              ...
              <div className='bg-gray-800 p-4 rounded-lg font-mono text-sm'>
                ...
                <div>
                  {' '}
                  <span className='text-green-300'>background</span>:{' '}
                  <span className='text-yellow-200'>#e2e891</span>;
                </div>
                <div>
                  {' '}
                  <span className='text-green-300'>padding</span>:{' '}
                  <span className='text-yellow-200'>16px 24px</span>;
                </div>
                <div>{`}`}</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='bg-gray-800 p-4 rounded-lg font-mono text-sm'>
                ...
                <div>
                  <span className='text-purple-300'>BRAND_COLORS</span>.
        ...
        <div className='space-y-8'>
          <div className='text-center mb-8'>
            ...
            <p className='text-xl text-gray-300'>
              Our entire design system starts with just 4 core brand colors
            </p>
          </div>
